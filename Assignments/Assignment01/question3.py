...
while True: 
    # input the ticket code 
    ticket_code = input("Please enter a ticket code:\n")
    
    # use ticketValidator2 
    result = ticketValidator2(ticket_code)
    
    # ticket code is valid => display a congratulatory message and stop the program
    if result == "Valid":
        print("Congratulations. Your ticket code is valid.")
        break
    # ticket code is invalid => display the reason(s) and ask for a new ticket code.
    else: 
        print(result)